                ...
                <CardContent>
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid size={4} gap="2px" display="flex" justifyContent="space-around" alignItems="center">
                            ...
                            <IconButton onClick={() => { handleEditDialog(todo) }} className='btnhover edit' aria-label="edit" style={{ padding: "3px", border: "1px solid #1769aa", backgroundColor: "white", color: "#1769aa" }}>
                                <EditIcon />
                            </IconButton>
                            <IconButton onClick={() => { handleDeleteDialog(todo) }} className='btnhover delete' aria-label="delete" style={{ padding: "3px", border: "1px solid #b23c17", backgroundColor: "white", color: "#b23c17" }}>
                                <DeleteIcon />
                            </IconButton>
                        </Grid>
                    </Grid>
